...
\begin{tabular}{ll}
\textbf{Vorname}:            & \TextField[width=0.65\textwidth,name=vorname]{} \\\\
\textbf{Nachname}:           & \TextField[width=0.65\textwidth,name=nachname]{} \\\\*[.5em]
\textbf{Straße, Hausnummer}: & \TextField[width=0.65\textwidth,name=strasse]{} \\\\
\textbf{PLZ}:                & \TextField[width=0.2\textwidth,name=plz]{}  \\\\
\textbf{Wohnort}:            & \TextField[width=0.65\textwidth,name=wohnort]{} \\\\*[.5em]
\textbf{Geburtsdatum}:       & \TextField[width=0.65\textwidth,name=dob]{} \\\\
\textbf{Email}:              & \TextField[width=0.65\textwidth,name=email]{} \\\\
PGP/GPG Schlüssel:  & \TextField[width=0.65\textwidth,name=gpg]{} \\\\
\end{tabular}
...
\begin{Form}
\ChoiceMenu[radio=true,radiosymbol=\ding{108},name=Mitgliedstyp]{}{ordentliches Mitglied,\hspace{4em}Fördermitglied}\\*[.5em]
\end{Form}
...
\begin{Form}
\begin{tabular}{llll}
Datum:        & \TextField[height=0.01cm, width=0.2\textwidth, name=signature]{} & Unterschrift: & \\
\end{tabular}
